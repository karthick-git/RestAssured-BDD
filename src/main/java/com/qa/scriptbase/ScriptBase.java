package com.qa.scriptbase;

import com.qa.utils.CommonSeleniumTasks;
...
public class ScriptBase extends CommonSeleniumTasks {
    ...
    public void setup(@Optional String browser) {
        ...
        objectRepositoryManager.load(
                (userDirectory + "/src/main/resources/properties/SpreeNavigationObjectRepository.properties"),
                (userDirectory + "/src/main/resources/properties/SpreeHomePageObjectRepository.properties"),
                (userDirectory + "/src/main/resources/properties/SpreeLoginPageObjectRepository.properties")
        );
